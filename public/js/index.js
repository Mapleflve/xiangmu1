...
//         success: function (res) {
            ...
            $(window).scroll(function () {
                ...
                if (t > 100) {
                    // header背景颜色
                    $(".travell.fixed-top").css({ 'background-color': '#fff' });
                    // 字体颜色
                    $('.travell .shouye div a').css({ 'color': '#424242' })
                    // 第一个字颜色
                    $('.travell .shouye .first a').css({ 'color': '#0fc7d1' })
                    // 三角形
                    $('.travell .shouye div span').css({
                    ...
                    // 去掉header背景颜色
                    $(".travell.fixed-top").css({'background-color':''});
                    // 字体颜色
                    $('.travell .shouye div a').css({ 'color': '#fff' })
                    // 第一个字颜色
                    $('.travell .shouye .first a').css({ 'color': '#0fc7d1' })
                    // 三角形
                    $('.travell .shouye div span').css({
